...
\mono{get\_sensor\_data}. För instruktioner med argument består strängen av
...
ljusstyrkan från reflexsensorn på taxins undersida. Låga tal motsvarar mycket
reflektion och höga tal motsvarar mindre reflektion.

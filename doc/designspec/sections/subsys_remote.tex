...
\item[stopplinje] \mono{stop} om markerad som destination, annars
    \mono{ign}.
\item[parkeringsficka] \mono{park} om markerad som destination,
    annars \mono{ign}.
\item[rondell] En \mono{enter}, därefter en \mono{ign} för varje avfart
    den ska passera och slutligen en \mono{exit}.
\end{labeling}

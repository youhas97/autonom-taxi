...
\begin{labeling}{wwww}
    \item[\mono{ignr}] Kör förbi stopplinjen utan att stanna.
    \item[\mono{entr}] Sväng höger in i rondellen och hitta rondellens körfil.
    \item[\mono{exit}] Sväng höger ut ur rondellen och hitta körfilen.
    \item[\mono{stop}] Stanna framför stopplinjen, fortsätt efter några
    sekunder om kön inte är tom.
    \item[\mono{park}] Parkera i fickan till höger efter stopplinjen, lämna

...
\begin{labeling}{wwww}
    \item[\mono{ign}] Kör förbi stopplinjen utan att stanna.
    \item[\mono{ent}] Sväng höger in i rondellen och hitta rondellens körfil.
    \item[\mono{ext}] Sväng höger ut ur rondellen och hitta körfilen.
    \item[\mono{stp}] Stanna framför stopplinjen, fortsätt efter några
    sekunder om kön inte är tom.
    \item[\mono{prk}] Parkera i fickan till höger efter stopplinjen, lämna

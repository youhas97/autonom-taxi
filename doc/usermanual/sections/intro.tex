...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{\figures/switch.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{\figures/motorknapp.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{\figures/reset.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{\figures/batteri.jpg}

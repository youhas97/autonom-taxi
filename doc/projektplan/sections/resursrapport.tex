...
gränssnittet för den bärbara datorn kanförslagsvis skrivas i Python medan
...
Rapporterna ska skrivas varje veckoslut och ska innehålla alla den gångna
veckans aktiviteter. Den slutgiltiga tidsrapporten ska sedan skickas till
...
till att korrigera arbetet. På mötena kommer gruppmedlemmarna att rapportera
...
eller om något krav behöver omförhandlas. För detaljerad bild av

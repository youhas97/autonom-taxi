...
\begin{activitylist}
    ...
    \activity{comm:sw}{Mjukvara}{40}{}{Designa och implementera ett
    basprogram som körs på Raspberry Pi-processorn.}
    \activity{comm:design}{Design}{20}{}{Designa konstruktionsmodulen.}
    \activity{comm:constr}{Konstruktion}{20}{}{Konstruera hårdvaran av
    kommunikationsmodulen.}
    \activity{comm:cam}{Kamera}{8}{}{Installera kamera och gör dess bilder
    bearbetningsbara.}
    \activity{comm:map}{Tolka karta}{10}{\aref{ui:map-in}}{Tolka inmatad karta,
    skapa en lämplig representation.}
    \activity{comm:remote}{Fjärrstyrning}{5}{}{Skicka och ta emot
    ...
    \actcat{Styrmodul}
    \activity{comm:sw}{Mjukvara}{30}{}{Designa och implementera ett basprogram
    som körs på.}
    \activity{ctrl:design}{Design}{10}{}{Designa styrmodulen.}
    \activity{ctrl:constr}{Konstruktion}{10}{}{Konstruera hårdvaran av
    styrmodulen.}
    ...
    \actcat{Sensormodul}
    \activity{comm:sw}{Mjukvara}{30}{}{Designa och implementera ett basprogram
    som körs på sensormodulens mikrokontroller.}
    \activity{sens:design}{Design}{10}{}{Designa sensormodulen.}
    \activity{sens:constr}{Konstruktion}{10}{}{Konstruera hårdvaran av
    sensormodulen.}
    ...
    \activity{sdc:tsp}{Hitta närmaste väg}{10}{}{Hitta närmaste vägen mellan
    två stopplinjer i en karta.}
    \activity{sdc:roundabout}{Kör igenom rondell}{10}{}{Kör autonomnt genom
    rondeller med godtycklig utfart.}
    \activity{sdc:map}{Avgör position.}{8}{\aref{comm:map}}{Bestäm taxins
    position i karta.}
    ...
    \activity{adm:meet}{Möten}{40}{}{Ha regelbundna möten.}

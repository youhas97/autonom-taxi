...
\begin{activitylist}
    ...
    alla moduler.}
    \activity{des:hwmod}{Modulshårdvara}{60}{}{Designa hårdvaran av
    kommunikationsmodulen, styrmodulen och sensormodulen.}
    \activity{des:sw}{Mjukvara}{50}{}{Designa strukturerna för fjärrklientens,
...
\begin{activitylist}
    ...
    \actcat{Styrmodul}
    \activity{ctrl:drive}{Drivmotor}{2}{\aref{all:install,all:sw}}{Reglera
    taxins fart genom att kontrollera drivmotorn utifrån kommunikationsmodulens
    kommandon.}
    \activity{ctrl:steer}{Svängmotor}{2}{\aref{all:install,all:sw}}{Reglera
    ...
    taxi.}
    \activity{ui:param}{Mata in parametrar}{2}{\aref{all:sw}}{Mata in
    konstantparametrer under körning.}
    \activity{ui:data}{Visa mätdata}{2}{\aref{all:sw}}{Visa upp mätdata från
    taxin.}
    ...
    länk}{8}{\aref{all:sw,all:install}}{Implementera en trådlös länk mellan
    ...
    \actcat{Administrativt}
    \activity{adm:meet}{Möten}{20}{}{Genomföra möten.}

...
\begin{activitylist}
    ...
    \actcat{Dokument}
    \activity{doc:spec}{Rapporter}{75}{}{Skriva, formatera och sammanställa
    rapporter.}
...
\begin{activitylist}
    ...
    \activity{sdc:gps}{Avgör position.}{8}{\aref{all:sw,sdc:map}}{Tolka karta
    och bestäm taxins position i kartan.}
    ...
    sensorvärden}{10}{\aref{all:install}}{Filtrera brus från analoga sensorer
    och konvertera värden till SI-enheter..}
    ...
    implementationen.}
    \activity{doc:study}{Efterstudie och presentation}{20}{}{Utför en
    efterstudie och förbered en presentation.}
    \activity{doc:manual}{Användar\-manual}{20}{}{Skriv en användarmanual.}
    \activity{doc:report}{Tids- och statusrapporter}{20}{}{Skriva
    tids- och statusrapporter.}

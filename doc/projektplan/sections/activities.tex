...
\begin{activitylist}
    ...
    \actcat{Design}
    \activity{hwdes:all}{Systemet}{20}{}{Designa sammankopplingen mellan alla
    moduler.}
    \activity{hwdes:mod}{Kommunikations\-modul}{40}{}{Designa hårdvaran av
    kommunikationsmodulen, styrmodulen och sensormodulen.}
    \activity{swdes:comm}{Kommunikations\-modul}{50}{}{Designa strukturerna för

...
\begin{activitylist}
    ...
    \actcat{Sensormodul}
    \activity{sens:filter}{Filtrera brus}{3}{}{Filtrera brus från analoga
    sensorer.}
    \activity{sens:conv}{Konvertera värden}{2}{}{Konvertera sensorvärden
    till SI-enheter.}
    \activity{sens:send}{Skicka värden}{2}{}{Skicka värden till
    ...
    \activity{doc:time-reports}{Tidsrapporter}{10}{}{Rapportera tid varje vecka.}
\end{activitylist}

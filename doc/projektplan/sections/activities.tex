...
\begin{activitylist}
    ...
    i bilder.}
    \activity{ip:line}{Upptäck linjer.}{35}{\aref{ip:edge}}{Upptäck
    ...
    \activity{ip:err}{Avgör felvärde.}{30}{\aref{ip:2d}}{Beräkna felvärde från
    linjekarta.}
    ...
    \activity{sdc:nav}{Navigera}{40 (TODO: öka)}{\aref{sdc:gps,sdc:reg}}{Navigera
    till godtycklig stopplinje eller parkeringsficka med eventuella hinder.}

...
\begin{activitylist}
    ...
    länk}{8}{\aref{comm:sw,comm:constr}}{Implementera en trådlös länk mellan
    kommunikationsmodulen och fjärrklienten.}
    \activity{io:comm-sens}{Komm-sensor}{15}{\aref{comm:sw,comm:constr,
    sens:sw,sens:constr}}{Implementera seriellt protokoll för att kommunicera
    mellan kommunikations- och sensormodul.}
    \activity{io:comm-styr}{Komm-styr}{15}{\aref{comm:sw,comm:constr,ctrl:sw,
    ctrl:constr}}{Implementera seriellt protokoll för att kommunicera mellan
    kommunikations- och styrmodul.}

    \actcat{Autonom körning}
    \activity{sdc:sw}{Mjukvara}{10}{\aref{comm:sw,comm:constr}}{Designa och
    implementera bas för mjukvarudel som ska hantera taxins autonomomitet.}
    ...
    \activity{sdc:roundabout}{Kör igenom rondell}{10}{\aref{sdc:sw}}{Kör
    autonomt genom rondeller via godtycklig in- och utfart.}
    \activity{sdc:gps}{Avgör position.}{8}{\aref{sdc:sw,sdc:map}}{Bestäm taxins
    position i karta.}
    \activity{sdc:reg}{Följ vägfil}{10}{\aref{sdc:sw,ip:err,ctrl:drive,
    ctrl:steer}} {Reglera styrning utefter felvärde och följ höger vägfil.}
    \activity{sdc:stop-line}{Upptäck stopplinjer}{5}{\aref{sdc:sw}}{Upptäck
    stopplinjer i vägen.}
    ...
    \activity{ui:obstacle}{Hantera hinder}{8}{\aref{sdc:sw}}{Upptäck och stanna
    för hinder.}
    ...
    \actcat{Dokument}
    \activity{doc:designspec}{Designspe\-cifikation}{100}{}{Skapa detaljerad

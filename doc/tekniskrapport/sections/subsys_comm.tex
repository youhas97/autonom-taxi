...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{\figures/gauss.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{\figures/monochromatic.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{\figures/threshhold.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{\figures/edge_detection.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{\figures/mask_roi.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{\figures/lines.png}
...
\begin{labeling}{wwww}
    ...
    \item[\commStop] Sätter hastigheten till noll när stopplinjen är synlig.
        Avslutar när \mono{pos} är \mono{AFTER\_STOP} om kommandot är sist i
        kön, annars vänta fem sekunder och avsluta därefter.
    \item[\commPark] Sakta ner och sväng höger när \mono{pos} är
        \mono{AFTER\_STOP}. Låt bildbehandlingen därefter i en viss distans.
        Därefter sätt \mono{pos} till \mono{PARKED} och stanna. Om kommandot
        var sist i kön avslutas det där. Annars sätts \mono{pos} till
        \mono{UNPARKING} efter fem sekunder och svänger vänster i en viss
    ...
    \item[\commExit] Låt bildbehandlingen ignorera vänsterlinjen när \mono{pos}
        är \mono{AFTER\_STOP} så att bilen följer högerlinjen och åker ut ur

...
\begin{reqlist}
    ...
    levereras varje måndag från och med vecka 45 till och med vecka 51 2018.}
    ...
    \req{Teknisk dokumentation och användarhandledning ska levereras senast 13
    december 2018.}
    \req{Verifiering av kraven ska ske senast dagen innan redovisning som
    kommer att ske vecka 51 2018.}
    \req{En efterstudie för projektet skall lämnas till beställaren senast 20
    december 2018.}
    \req{Hårdvara och utrustning använda för taxin skall återlämnas senast den
    21 december.}
\end{reqlist}

\newpage % avoid pagebreak before table (may not be needed later)

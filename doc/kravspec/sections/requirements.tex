...
\begin{reqlist}
    ...
    välspecificerat gränssnitt för att tillåta smidiga utbyten av moduler.}
\end{reqlist}
...
\begin{reqlist}
    \req{Tidsrapporter som redovisar föregående veckas arbetad tid ska levereras vid
    varje måndag från och med vecka 46 till och med vecka 51 2018.}
    \req{Statusrapporter som redovisar projektets nuvarande status ska
    levereras vid begäran.}

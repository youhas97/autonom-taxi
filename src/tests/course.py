...
assert mission == [Command.ENTER, Command.CONTINUE, Command.CONTINUE, Command.CONTINUE, Command.CONTINUE, Command.CONTINUE, Command.CONTINUE, Command.EXIT, Command.STOP]